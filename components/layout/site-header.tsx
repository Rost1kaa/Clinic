...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-white/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto grid w-full max-w-[86rem] grid-cols-[minmax(0,1fr)_auto] items-center gap-x-4 gap-y-3 px-4 py-3.5 sm:px-6 lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:gap-x-5 lg:px-8 lg:py-4">
        ...
        <div className="hidden shrink-0 items-center justify-end gap-2 lg:flex">
          <Button asChild variant="ghost" size="sm" className="bg-white/55 shadow-sm hover:bg-white">
