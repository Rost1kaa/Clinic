...
export const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "ექიმი და ექთანი ერთ ვიზიტში მოვიდა და პროცესი ძალიან გამარტივდა. ყველაფერი მშვიდად და გასაგებად მოხდა.",
    rating: 5,
    location: "თბილისი",
  },
  {
    ...
    role: "ონლაინ პაციენტი",
    quote:
      "ონლაინ კონსულტაცია მარტივი და სწრაფი იყო. ანალიზებიც იმავე დღეს განვიხილეთ.",
    rating: 5,
    location: "რუსთავი",
  },
  {
    ...
    role: "კარდიოლოგიური სერვისი",
    quote:
      "სახლში ECG და კარდიოლოგის შეფასება ძალიან კომფორტული აღმოჩნდა. ყველაფერი დეტალურად აგვიხსნეს.",
    rating: 5,
    location: "თბილისი",
  },
  {
    ...
    role: "პაციენტი",
    quote:
      "ვიზიტის დაჯავშნა ძალიან მარტივი იყო. ყველაფერი სწრაფად მოგვარდა.",
    rating: 5,
    location: "თბილისი",
  },
  {
    id: "t-5",
    fullName: "მარიამ კობახიძე",
    role: "ონლაინ პაციენტი",
    quote:
      "ექიმთან ონლაინ კონსულტაცია ძალიან კომფორტულია. აღარ მიწევს რიგში დგომა.",
    rating: 5,
    location: "ბათუმი",
  },
  {
    id: "t-6",
    fullName: "დავით ჯაფარიძე",
    role: "პაციენტი",
    quote:
      "ექიმი დროულად მოვიდა სახლში და ყველაფერი დეტალურად ამიხსნა.",
    rating: 5,
    location: "ქუთაისი",
  },
  {
    id: "t-7",
    fullName: "ნინო შავაძე",
    role: "პაციენტი",
    quote:
      "ძალიან ორგანიზებული და სანდო სერვისია. აუცილებლად ისევ გამოვიყენებ.",
    rating: 5,
    location: "თბილისი",
  },
  {
    id: "t-8",
    fullName: "ეკა გელაშვილი",
    role: "პაციენტის ოჯახის წევრი",
    quote:
      "ანალიზების განხილვა და შემდეგი ნაბიჯები მარტივად აგვიხსნეს. თავს მშვიდად ვგრძნობდით.",
    rating: 5,
    location: "გორი",
  },
];
