...
export const stats: StatItem[] = [
  {
    label: "აქტიური ექიმები",
    value: "24+",
    description: "მულტიდისციპლინური გუნდი სხვადასხვა სპეციალობით.",
  },
  {
    label: "დაჯავშნის პასუხი",
    value: "< 15 წთ",
    description: "ოპერატიული უკუკავშირი სამუშაო საათებში.",
  },
  {
  ...
  {
    label: "პაციენტის შეფასება",
    value: "4.9/5",
    description: "სერვისის ხარისხსა და კომუნიკაციაზე მაღალი კმაყოფილება.",
  },
];

export const valuePoints: ValuePoint[] = [
  {
    title: "ერთიანი სამედიცინო გზა",
    description:
      "პირველადი კონსულტაციიდან დიაგნოსტიკამდე და მონიტორინგამდე ყველა ნაბიჯი ერთ პლატფორმაშია შეკრული.",
    icon: "activity",
  },
  {
    title: "სახლში მისვლის მზა გუნდი",
    description:
      "ექიმი, ექთანი და დიაგნოსტიკური სერვისი შეგვიძლია ერთ ვიზიტად დავაგეგმოთ.",
    icon: "house-plus",
  },
  {
    title: "ციფრული კომუნიკაცია",
    description:
      "ონლაინ კონსულტაციები, ოპერატიული დადასტურება და მკაფიო შემდგომი ინსტრუქციები.",
    icon: "video",
  },
  {
    title: "გეგმარებადი ხარისხი",
    description:
      "სტანდარტიზებული ჩანაწერები, სტატუსები, გადახდის მოდელები და უსაფრთხო მონაცემთა არქიტექტურა.",
    icon: "shield-check",
  },
];
...
export const testimonials: Testimonial[] = [
  {
    id: "t-1",
    fullName: "თამარ მახარაძე",
    role: "პაციენტის ოჯახის წევრი",
    quote:
      "ექიმის და ექთნის ერთ ვიზიტში მოსვლამ ძალიან გაგვიმარტივა პროცესი. კომუნიკაცია მშვიდი, მკაფიო და სწრაფი იყო.",
    rating: 5,
    location: "თბილისი",
  },
  {
    id: "t-2",
    fullName: "ლევან ქავთარაძე",
    role: "ონლაინ კონსულტაციის პაციენტი",
    quote:
      "ენდოკრინოლოგთან ონლაინ ვიზიტი პრაქტიკულად და ხარისხიანად ჩაიარა. ანალიზების განხილვაც იმავე დღეს მოვასწარით.",
    rating: 5,
    location: "რუსთავი",
  },
  {
    ...
    role: "კარდიოლოგიური სერვისის პაციენტი",
    quote:
      "სახლში ECG და კარდიოლოგის შეფასება ერთად ძალიან კომფორტული აღმოჩნდა. ყველაფერი გასაგებად აგვიხსნეს.",
    rating: 5,
    location: "თბილისი",
  },
];
